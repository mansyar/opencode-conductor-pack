/**
 * Template definitions for conductor artifact files
 * These templates are used by the /conductor:setup command
 * to initialize the conductor/ directory structure.
 */
...
/**
 * Product template - defines the project vision and goals
 */
export const productTemplate: string = `# Product Name
...
/**
 * Product Guidelines template - defines prose style and communication guidelines
 */
export const productGuidelinesTemplate: string = `# Product Guidelines
...
/**
 * Tech Stack template - defines the technology choices
 */
export const techStackTemplate: string = `# Tech Stack
...
/**
 * Workflow template - defines the development workflow
 * This is the full workflow document used by Conductor
 */
export const workflowTemplate: string = `# Project Workflow
...
3.  **Execute Automated Tests with Proactive Debugging:**
    ...
    -   If tests fail, inform the user and begin debugging. You may attempt to propose a fix a **maximum of two times**. If the tests still fail after your second proposed fix, **must stop**, report the persistent failure, and ask the user for guidance.
...
5.  **Await Explicit User Feedback:**
    -   After presenting the detailed plan, ask the user for confirmation: "**Does this meet your expectations? Please confirm with yes or provide feedback.**"
...
/**
 * Get all template files for conductor initialization
 */
export function getConductorTemplates(): TemplateFile[] {
  return [
    ...
    { filename: "workflow.md", content: workflowTemplate },
 ...
 */
export const typescriptStyleGuide: string = `# Google TypeScript Style Guide Summary
...
export const generalStyleGuide: string = `# General Code Style Principles
...
export const pythonStyleGuide: string = `# Python Style Guide (PEP 8)
...
export function getStyleGuideLibrary(): TemplateFile[] {
  return [
    { filename: "general.md", content: generalStyleGuide },
    { filename: "typescript.md", content: typescriptStyleGuide },
